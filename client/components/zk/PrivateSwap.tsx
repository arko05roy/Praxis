...
export function PrivateSwap() {
  ...
  const calculateMinAmountOut = (): bigint => {
    ...
    // Simplified: assume 1:1 rate for demo, minus slippage
      ...
      {step === "input" && (
        <>
                    ...
                    <div className="absolute right-0 top-full mt-1 bg-[#141a17] border border-white/10 rounded-lg shadow-xl z-10 min-w-[140px]">
                      {SUPPORTED_TOKENS.map((token) => (
                        <button
                          ...
                          className="w-full px-4 py-2 text-left hover:bg-white/5 text-white disabled:opacity-50"
          ...
          <div className="flex items-start gap-2 text-xs text-gray-500">
            ...
            <span>
              MockSimpleDEX will be used for this swap. Actual rates may vary.
