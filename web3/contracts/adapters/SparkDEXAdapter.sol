...
import {ISparkDEXRouter} from "../interfaces/external/ISparkDEXRouter.sol";
 ...
 * @notice Adapter for SparkDEX V3 (concentrated liquidity DEX on Flare)
 * @dev Implements swaps using Uniswap V3 style interface
 */
contract SparkDEXAdapter is BaseAdapter {
    using SafeERC20 for IERC20;

    /// @notice SparkDEX V3 Quoter contract
    ISparkDEXQuoter public immutable quoter;

    /// @notice SparkDEX V3 Factory contract
    IUniswapV3Factory public immutable factory;

    /// @notice Default fee tier (3000 = 0.3%)
    uint24 public defaultFeeTier;

    /// @notice Available fee tiers on SparkDEX V3
    ...
    /**
     * @notice Constructor
     * @param router_ SparkDEX V3 SwapRouter address
     * @param quoter_ SparkDEX V3 QuoterV2 address
     * @param factory_ SparkDEX V3 Factory address
     */
    constructor(
        address router_,
        address quoter_,
        address factory_
    ) BaseAdapter("SparkDEX V3", router_) {
        ...
        // Initialize available fee tiers
     ...
     * @dev Note: This function is view but uses staticcall internally
     *      The quoter simulates a swap and reverts with the result
    ...
    function swap(
        ...
        // Execute swap
        ISparkDEXRouter.ExactInputSingleParams memory params = ISparkDEXRouter
        ...
        amountOut = ISparkDEXRouter(_getRouter()).exactInputSingle(params);
